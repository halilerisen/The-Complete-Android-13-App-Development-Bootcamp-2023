package com.example.courserecordkeeper.running
...
import com.example.courserecordkeeper.databinding.FragmentRunningBinding
...
class RunningFragment : Fragment() {
    ...
    private fun displayRecords() {
        val runningPreferences = requireActivity().getSharedPreferences("running", Context.MODE_PRIVATE)
